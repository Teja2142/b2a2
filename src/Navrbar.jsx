    ...
    <div style={{ width: "100%", fontFamily: "sans-serif" }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <a href={socialLinks.phone} target="_blank" rel="noopener noreferrer" aria-label="Call us">
            <FontAwesomeIcon icon={faPhone} style={{ fontSize: "22px", cursor: "pointer", color: "#fff" }} />
          </a>
